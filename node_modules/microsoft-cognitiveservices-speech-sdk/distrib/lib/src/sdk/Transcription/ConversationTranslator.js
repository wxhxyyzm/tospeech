...
var ConversationTranslationRecognizer = /** @class */ (function (_super) {
    ...
    Object.defineProperty(ConversationTranslationRecognizer.prototype, "authentication", {
        set: function (token) {
    ...
    ConversationTranslationRecognizer.prototype.onCancelSpeech = function () {
...
var ConversationTranslator = /** @class */ (function (_super) {
    ...
    ConversationTranslator.prototype.onToken = function (token) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        this.privIsSpeaking = false;
                        return [4 /*yield*/, ((_a = this.privCTRecognizer) === null || _a === void 0 ? void 0 : _a.onCancelSpeech())];
                    case 1:
                        _b.sent();
