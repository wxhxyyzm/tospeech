...
var Meeting = /** @class */ (function () {
     ...
     * @param err
     */
    Meeting.createMeetingAsync = function (speechConfig, meetingId, arg3, arg4) {
        var _this = this;
        ...
        Contracts_1.Contracts.throwIfNull(meetingId, "meetingId");
        ...
        var meetingImpl = new MeetingImpl(speechConfig, meetingId);
