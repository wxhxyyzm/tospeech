...
var TranslationConnectionFactory = /** @class */ (function (_super) {
    ...
    TranslationConnectionFactory.prototype.setQueryParams = function (queryParams, config, endpointUrl) {
        ...
        queryParams.scenario = config.recognitionMode === Exports_3.RecognitionMode.Interactive ? "interactive" :
            config.recognitionMode === Exports_3.RecognitionMode.Conversation ? "conversation" : "";
