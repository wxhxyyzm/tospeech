...
var ConversationTranslatorRecognizer = /** @class */ (function (_super) {
    ...
    function ConversationTranslatorRecognizer(conversation, speechConfig, audioConfig) {
        ...
        var webWorkerLoadType = _this.privProperties.getProperty(Exports_3.PropertyId.WebWorkerLoadType, "on").toLowerCase();
        if (webWorkerLoadType === "on" && typeof (Blob) !== "undefined" && typeof (Worker) !== "undefined") {
            _this.privSetTimeout = Exports_2.Timeout.setTimeout;
            _this.privClearTimeout = Exports_2.Timeout.clearTimeout;
        }
        else {
            if (typeof window !== "undefined") {
                // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
                _this.privSetTimeout = window.setTimeout.bind(window);
                // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
                _this.privClearTimeout = window.clearTimeout.bind(window);
            }
            else {
                _this.privSetTimeout = setTimeout;
                _this.privClearTimeout = clearTimeout;
            }
        }
        return _this;
    }
     ...
     */
    ConversationTranslatorRecognizer.prototype.onToken = function (token) {
